...
- `Documentation/Product/ClientContext_Audit_04_Trackers_Core.md` - audits core tracker status across Weight, Mood, Exercise, Gaming, Diet/Meals, Social, Books, Media/TV, Tasks, Hydration, Savings, and doc-only/future trackers.
