...
"[project]/app/tracking/mood/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MoodPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MoodPage.useEffect": ()=>{
            const calculateCellSize = {
                "MoodPage.useEffect.calculateCellSize": ()=>{
            ...
            return ({
                "MoodPage.useEffect": ()=>resizeObserver.disconnect()
            })["MoodPage.useEffect"];
        }
    }["MoodPage.useEffect"], []);
    ...
    const isValidPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MoodPage.useCallback[isValidPosition]": (x, y, width, height, excludeId)=>{
            if (x < 0 || y < 0 || x + width > GRID_COLS || y + height > GRID_ROWS) return false;
            return visibleWidgets.every({
                "MoodPage.useCallback[isValidPosition]": (w)=>w.id === excludeId || x >= w.position.x + w.size.width || x + width <= w.position.x || y >= w.position.y + w.size.height || y + height <= w.position.y
            }["MoodPage.useCallback[isValidPosition]"]);
        }
    }["MoodPage.useCallback[isValidPosition]"], [
        visibleWidgets
    ]);
    const findOverlappingWidgets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MoodPage.useCallback[findOverlappingWidgets]": (x, y, width, height, excludeId)=>visibleWidgets.filter({
                "MoodPage.useCallback[findOverlappingWidgets]": (w)=>w.id !== excludeId && x < w.position.x + w.size.width && x + width > w.position.x && y < w.position.y + w.size.height && y + height > w.position.y
            }["MoodPage.useCallback[findOverlappingWidgets]"])
    }["MoodPage.useCallback[findOverlappingWidgets]"], [
        visibleWidgets
    ]);
    const findFirstAvailablePosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MoodPage.useCallback[findFirstAvailablePosition]": (width, height, excludeIds)=>{
            for(let y = 0; y <= GRID_ROWS - height; y++)for(let x = 0; x <= GRID_COLS - width; x++)if (visibleWidgets.every({
                "MoodPage.useCallback[findFirstAvailablePosition]": (w)=>excludeIds.includes(w.id) || x >= w.position.x + w.size.width || x + width <= w.position.x || y >= w.position.y + w.size.height || y + height <= w.position.y
            }["MoodPage.useCallback[findFirstAvailablePosition]"])) return {
                x,
                y
            };
            return null;
        }
    }["MoodPage.useCallback[findFirstAvailablePosition]"], [
        visibleWidgets
    ]);
    const relocateWidgets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MoodPage.useCallback[relocateWidgets]": (activeWidgetId, newX, newY, activeWidth, activeHeight)=>{
            ...
            let newWidgets = visibleWidgets.map({
                "MoodPage.useCallback[relocateWidgets].newWidgets": (w)=>w.id === activeWidgetId ? {
                        ...w,
                        position: {
                            x: newX,
                            y: newY
            ...
            }["MoodPage.useCallback[relocateWidgets].newWidgets"]);
            ...
            for (const dw of displaced){
                ...
                newWidgets = newWidgets.map({
                    "MoodPage.useCallback[relocateWidgets]": (w)=>w.id === dw.id ? {
                            ...w,
                            position: newPos
                        } : w
                }["MoodPage.useCallback[relocateWidgets]"]);
            }
            return newWidgets;
        }
    }["MoodPage.useCallback[relocateWidgets]"], [
    ...
    const createOccupationMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MoodPage.useCallback[createOccupationMap]": (excludeId)=>{
            const map = Array(GRID_ROWS).fill(null).map({
                "MoodPage.useCallback[createOccupationMap].map": ()=>Array(GRID_COLS).fill(false)
            }["MoodPage.useCallback[createOccupationMap].map"]);
            visibleWidgets.filter({
                "MoodPage.useCallback[createOccupationMap]": (w)=>w.id !== excludeId
            }["MoodPage.useCallback[createOccupationMap]"]).forEach({
                "MoodPage.useCallback[createOccupationMap]": (w)=>{
            ...
            }["MoodPage.useCallback[createOccupationMap]"]);
            return map;
        }
    }["MoodPage.useCallback[createOccupationMap]"], [
        visibleWidgets
    ...
    const pixelToGrid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MoodPage.useCallback[pixelToGrid]": (pixelX, pixelY)=>({
    ...
    }["MoodPage.useCallback[pixelToGrid]"], [
        cellSize
    ]);
...
_s(MoodPage, "KDvZHe+xYJiqIgq0yTStwtvWDj8=", false, function() {
    return [
...
//# sourceMappingURL=_ea258df5._.js.map